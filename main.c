...
int main(int argc, char* args[]) {
    ...
    colormap = loadgif("maps/gif/map3.color.gif", &map_width, &map_height, &pal_count, palette);
    heightmap  = loadgif("maps/gif/map3.height.gif", &map_width, &map_height, NULL, NULL);
